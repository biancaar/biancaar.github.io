...
export const translations = {
  it: {
    ...
    hero: {
      subtitleLine1: "CREATIVE DEVELOPER",
      subtitleLine2: "3D & INTERACTIVE EXPERIENCES"
    },
    home: {
      about: {
        title: "About Me",
    ...
    footer: {
      ...
      rights: "(c) 2026 - All rights reserved"
    },
    project: {
      notFound: "Project not found",
      backToTopAria: "Back to top",
      navigationTitle: "Projects",
      navigationSubtitle: "Seleziona un progetto"
    }
  },
  en: {
    nav: {
    ...
    home: {
      about: {
        title: "About Me",
        paragraphs: [
          "My passion for programming started when I was 14, beginning with web design and basic websites. I then deepened my knowledge of SQL, JavaScript and PHP.",
      ...
      contact: {
        title: "Contact Me",
        paragraphs: [
          "I am currently looking for new opportunities in web development, with a strong interest in projects that combine design, interaction and technology.",
          "If you think my profile could fit your team or project, I would be glad to connect."
        ],
        phoneLabel: "Phone",
        emailLabel: "E-mail",
        form: {
    ...
    project: {
      ...
      backToTopAria: "Back to top",
      navigationTitle: "Projects",
      navigationSubtitle: "Select a project"
    }
  }
};
